package com.selenium.driver.javascript;
...
public class Js {
    ...
    public String getElementText(By locator, int elementIndex) {

        String locatorWithIndex = webDriver.findElements(locator).get(elementIndex).toString();
        return (String) getEval("return arguments[0].value;", locatorWithIndex);
    }
    ...
    /**
     * Focuses on element by Id
     * * @param elementId is element Id as string
     */
    public void focusOnElementById(String elementId) {
        getEval("document.getElementById(\"" + elementId + "\").focus();");
        waitFor.milliSeconds(500);
    }

    /**
     * Focuses on element by class name
     * * @param elementClassName is element className as string
     */
    public void focusOnElementByClassName(String className) {
        getEval("document.getElementsByClassName(\"" + className + "\")[0].focus();");
        waitFor.milliSeconds(500);
    }
