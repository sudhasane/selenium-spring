...
public class Find {
    ...
    public WebElement element(By locator) {
        ...
        for (int i = 0; i < 5; i++) {
            try {
                ...
                System.out.println("DEBUG AUTOMATION PACK : HANG ISSUE : In catch whilst looking for locator :" + locator);
                Times.waitForMilliSeconds(Times.SECOND_PAUSE);
            }
        }
        System.out.println("DEBUG AUTOMATION PACK : HANG ISSUE : I will now be throwing RuntimeException.");
    ...
    public WebElement element(By locator, int elementIndex) {

        return elements(locator).get(elementIndex);
    }
