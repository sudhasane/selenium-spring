...
public class ConditionFactory {
    ...
    public static ExpectedCondition<Boolean> elementVisibleTextLengthIsNotNull(final By locator) {
        ...
        return new ExpectedCondition<Boolean>() {
            ...
            public Boolean apply(WebDriver driver) {
                ...
                try {
                    ...
                    return !driver.findElement(locator).getText().equals("");
                }
                catch (StaleElementReferenceException e) {
                    return null;
                }
            ...
            public String toString() {
                ...
                return ("Error Message is not displayed for the locator : " + locator);
            }
        };
    }

    public static ExpectedCondition<Boolean> elementToHaveTextLength(final By locator, int length) {

        return new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver driver) {
                return driver.findElement(locator).getText().length()>=length;

            }
            @Override
            public String toString() {

                return String.format("Text is less than the expected", locator);
            }
        };
    }
